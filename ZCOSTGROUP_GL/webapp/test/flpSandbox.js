		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "원가그룹 GL계정관리",
									"targetURL": "#zcostgroupgl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcostgroupgl-display": {
								"semanticObject": "zcostgroupgl",
								"action": "display",
								"description": "원가그룹 GL계정관리",
								"title": "원가그룹 GL계정관리",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcostgroupgl",
									"url": sap.ui.require.toUrl("zcostgroupgl")
								}
							}
						}
					}
