    sap.ui.define([
        "zcostgroupgl/controller/BaseController",
        "sap/ui/model/Sorter",
        "sap/ui/model/Filter",
        ...
        "sap/m/Button",
        "sap/m/Dialog",
        "zcostgroupgl/sheetjs/jszip",
        "zcostgroupgl/sheetjs/xlsx.full.min"
        ...
        function (Controller, Sorter, Filter, FilterOperator, JSONModel, ODataModel, ResourceModel, Spreadsheet, MessageToast, MessageBox, SearchField, Button, Dialog) {
            ...
            return Controller.extend("zcostgroupgl.controller.Main", {
                ...
                setInitPage : function(oView){
                    ...
                    //view.xml table id
                    _oTable = oView.byId("iCOSTGROUPGLList");
                    
                    //view.xml table row path model
                    _oViewTableModel = this._createJSONModel(oView,"oZCOSTGROUPGL");
                    ...
                    //main model
                    _oModelMain = this._setCustomModel(_oDataList, oView, "oMODELMAIN", "/sap/opu/odata/sap/YY1_ZCOSTGROUP_GL_CDS/", "/YY1_ZCOSTGROUP_GL", "ODataModel");
                    ...
                    self._getODataModelRead(_oDataList["oMODELMAIN"]).done(function (aDataArr) {
                        ...
                        Promise.all(aDeleteCallArr).then(function () {
                            ...
                            aSelectedRows.forEach(function (item) {
                                ...
                                oData.WIP_GL = item.WIP_GL;
                                oData.COST_GL = item.COST_GL;
                                oData.FERT_GL = item.FERT_GL;
                                oData.COGS_GL = item.COGS_GL;
                ...
                onValueHelpRequested: function(oEvent, param) {
                    ...
                    this.loadFragment({
                        name: "zcostgroupgl/view/fragment/" + sDialogName,
                ...
                onFilterBarSearch: function (oEvent) {
                    ...
                    var sPath1, sPath2;
                    if (this._oVHD.getKey() === "COSTGROUP") {
                        sPath1 = "COSTGROUP";
                ...
                excelProcess : function (data) {
                    ...
                    excelRows.forEach(function(item,idx){
                        ...
                        exData.WIP_GL = item[_i18n.getText("WIP_GL")];
                        exData.COST_GL = item[_i18n.getText("COST_GL")];
                        exData.FERT_GL = item[_i18n.getText("FERT_GL")];
                        exData.COGS_GL = item[_i18n.getText("COGS_GL")];
                        exData.USEYN = vUSEYN;
                        exData.editRow = true;
                ...
                excelTempletDown : function(){
                    ...
                    oDataSample.WIP_GL = "1";
                    oDataSample.COST_GL = "2";
                    oDataSample.FERT_GL = "3";
                    oDataSample.COGS_GL = "4";
                    oDataSample.USEYN = "X";
                    ...
                    oDataSample.COSTGROUPTEXT = "";
                    oDataSample.WIP_GL = "11";
                    oDataSample.COST_GL = "22";
                    oDataSample.FERT_GL = "33";
                    oDataSample.COGS_GL = "44";
                    oDataSample.USEYN = "";
                    oDataTemp.push(oDataSample);
                ...
                excelColumnTempConfig : function(){
                    return [
                        ...
                        { label : _i18n.getText("WIP_GL"), 			        property : "WIP_GL" },
                        { label : _i18n.getText("COST_GL"), 			    property : "COST_GL" },
                        { label : _i18n.getText("FERT_GL"), 			    property : "FERT_GL" },
                        { label : _i18n.getText("COGS_GL"), 			    property : "COGS_GL" },
