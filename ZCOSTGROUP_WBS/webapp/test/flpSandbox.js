		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "원가그룹-WBS관리",
									"targetURL": "#zcostgroupwbs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcostgroupwbs-display": {
								"semanticObject": "zcostgroupwbs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcostgroupwbs",
									"url": sap.ui.require.toUrl("zcostgroupwbs")
								}
							}
						}
					}
