sap.ui.define([
    "zwbsglastep3/controller/BaseController",
	"sap/ui/model/Filter",
    ...
    "zwbsglastep3/sheetjs/jszip",
    "zwbsglastep3/sheetjs/xlsx.full.min"
],
    /**
    ...
    function (Controller, Filter, FilterOperator, JSONModel,ODataModel, MessageToast, MessageBox, Currency, MetadataHelper, P13nHandler, Engine, CoreLibrary, CellSelector, CopyProvider, MultiSelectionPlugin, Spreadsheet ) {
        ...
        return Controller.extend("zwbsglastep3.controller.Main", {
            ...
            setInitPage : function(oView){
                ...
                //view.xml table id
                _oTable = oView.byId("iWBSGLASTEP3List");
                ...
                this.oMetadataHelper = new MetadataHelper([
                    {
                        key: "FertilizerGL",
                        label: _i18n.getText("FertilizerGL"),
                        path: "FertilizerGL",
                    },
                    {
                        key: "FertilizerGLText",
                        label: _i18n.getText("FertilizerGLText"),
                        path: "FertilizerGLText",
                    },
                    {
                        key: "WBSElement",
            ...
            resetToInitialState: function() {
                ...
                var oTable = oView.byId("iWBSGLASTEP3List");
            ...
            performSearch: function (vEvent) {
                ...
                var aFilterSTEP = [
                    new Filter("STEP", FilterOperator.EQ, "3"),
                ...
                var aFilterPROGRAMID  = [
                    new Filter("PROGRAMID", FilterOperator.EQ, "3"),
                ...
                $.when(     
                    ...
                    oResultsStep.forEach(function(result) {
                        ...
                        if (matchingCostGroup) {
                            ...
                            result.COSTGOODSGL = matchingCostGroup.COGS_GL;
                        }
                    })
                    ...
                    $.when(     
                        ...
                        oResults.forEach(elementRows => {
                            for (const row of oResultsStep) {
                                if (parseInt(row["GLACCOUNT"]) === parseInt(elementRows.GLAccount)) {
                                    ...
                                    elementRows.CostGoodsGL = row.COSTGOODSGL
                            ...
                            if(aGroup.length > 0){
                                ...
                                // 조건에 일치하는 데이터가 없다면
                                    ...
                                    var newItem = {
                                            ...
                                            CostGoodsGL : elementRows.CostGoodsGL,
                        ...
                        aArray.forEach(function(oItemA) {
                            ...
                            var aCOSTGLAccount = oGLACCOUNTData.filter(function(oItem) {
                                return oItem.GLAccount === oItemA.CostGoodsGL;
                            });
                            oItemA.CostGoodsGLText = aCOSTGLAccount[0].GLAccountName;
            ...
            onFieldLiveChange: function(oEvent) {
                ...
                if (aPastedData.length > 1) {
                      oInput.setValue("");
                  var oTable = this.getView().byId("iWBSGLASTEP3List");
            ...
            onPost: function() {
                ...
                var oTable = self.getView().byId("iWBSGLASTEP3List");
                oTable.setBusy(true);
            ...
            callSoapApi: function() {
                ...
                self._getODataModelRead(_oDataList["oPOSTING"],aFilterPosting,null,null).done(function(aExistingData) {
                    ...
                    var vHeaderText = vYear + '.' + vDocumentDate + " 매출원가 대체";
                                        ...
                                        <JournalEntry>
                                            ...
                                            ${aData.map((oData, index) => `
                                                <Item>
                                                    ...
                                                    <GLAccount listID="">${oData.COGS_GL}</GLAccount>
                                                ...
                                                <Item>
                                                    ...
                                                    <CompanyCode>${oData.CompanyCode}</CompanyCode>
                                                    <GLAccount listID="YCOA">${oData.FERT_GL}</GLAccount>
                                                    <AmountInTransactionCurrency currencyCode="${oData.CompanyCodeCurrency}">${oData.ProductSubstitute > 0 ? -Math.abs(oData.ProductSubstitute) : Math.abs(oData.ProductSubstitute)}</AmountInTransactionCurrency>
            ...
            proceedWithPost: function() {
                ...
                aSelectedData.forEach(function(oItemA) {
                    ...
                    //if (oItemA.FertilizerGL && oItemA.CostGoodsGL && oItemA.ProductSubstitute != "" ) {
                    if (oItemA.FertilizerGL && oItemA.CostGoodsGL) {  
                        var oJoinedItem = {
                        ...
                        oJoinedItem.COGS_GLTEXT = aCOSTGLAccount[0].GLAccountName;
