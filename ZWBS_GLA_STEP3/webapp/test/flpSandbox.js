		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WBS별 재고자산-매출원가 대체",
									"targetURL": "#zwbsglastep3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zwbsglastep3-display": {
								"semanticObject": "zwbsglastep3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zwbsglastep3",
									"url": sap.ui.require.toUrl("zwbsglastep3")
								}
							}
						}
					}
