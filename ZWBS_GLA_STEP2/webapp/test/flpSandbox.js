		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WBS별 재고자산--제품 대체",
									"targetURL": "#zwbsglastep2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zwbsglastep2-display": {
								"semanticObject": "zwbsglastep2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zwbsglastep2",
									"url": sap.ui.require.toUrl("zwbsglastep2")
								}
							}
						}
					}
