		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "대상원가계정관리",
									"targetURL": "#zcostgroupstep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcostgroupstep-display": {
								"semanticObject": "zcostgroupstep",
								"action": "display",
								"description": "대상원가계정관리",
								"title": "대상원가계정관리",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcostgroupstep",
									"url": sap.ui.require.toUrl("zcostgroupstep")
								}
							}
						}
					}
