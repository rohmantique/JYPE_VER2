sap.ui.define(
    ...
    function(BaseController, Sorter, Filter, FilterOperator, JSONModel, ODataModel, Spreadsheet, MessageToast, MessageBox, SearchField, Button, Dialog) {
      ...
      return BaseController.extend("wbsglaccount.controller.App", {
        onInit: function() {
        ...
        _getODataDelete: function(oModel, readContext) {
            ...
            odataModel.refreshSecurityToken(function(sToken, oResponse) {
                // The token is fetched, now make the DELETE request with the token
                odataModel.remove(readContext, {
                    headers: {
                        // Include the fetched CSRF token in the DELETE request header
                ...
                odataModel.read(param.ReadContext, {
                    ...
                    error: function(oError) {
                        ...
                        try {
                            ...
                            MessageToast.show("Error parsing response: " + e.message);
                        }
                        } else {
