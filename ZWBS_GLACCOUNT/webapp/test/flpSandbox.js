		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WBS별 원가비용계정 집계",
									"targetURL": "#wbsglaccount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wbsglaccount-display": {
								"semanticObject": "wbsglaccount",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wbsglaccount",
									"url": sap.ui.require.toUrl("wbsglaccount")
								}
							}
						}
					}
